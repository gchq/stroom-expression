...
public class TestExpressionParser {
    ...
    public void testMin1() throws ParseException {
        ...
        Var out = gen.eval();
        Assert.assertEquals(180D, out.asDouble(), 0);
        ...
        out = gen.eval();
        Assert.assertEquals(13D, out.asDouble(), 0);
    }
    ...
    public void testMinUngrouped2() throws ParseException {
        ...
        Assert.assertEquals(8D, out.asDouble(), 0);
    }
    ...
    public void testMin3() throws ParseException {
        ...
        Var out = gen.eval();
        Assert.assertEquals(2D, out.asDouble(), 0);

        gen.set(getVal(300D));
        gen.set(getVal(180D));

        out = gen.eval();
        Assert.assertEquals(4D, out.asDouble(), 0);
    }
    ...
    public void testMax1() throws ParseException {
        ...
        Var out = gen.eval();
        Assert.assertEquals(300D, out.asDouble(), 0);

        gen.set(getVal(500D));

        out = gen.eval();
        Assert.assertEquals(500D, out.asDouble(), 0);
        ...
        out = gen.eval();
        Assert.assertEquals(600D, out.asDouble(), 0);
    }
    ...
    public void testMaxUngrouped2() throws ParseException {
        ...
        final Var out = gen.eval();
        Assert.assertEquals(100D, out.asDouble(), 0);
    }
    ...
    public void testMax3() throws ParseException {
        ...
        Var out = gen.eval();
        Assert.assertEquals(3D, out.asDouble(), 0);
    ...
    public void testSum() throws ParseException {
        ...
        out = gen.eval();
        Assert.assertEquals(5D, out.asDouble(), 0);
    }
    ...
    public void testSumOfSum() throws ParseException {
        ...
        Var out = gen.eval();
        Assert.assertEquals(7D, out.asDouble(), 0);

        gen.set(getVal(1D));
        gen.set(getVal(1D));

        out = gen.eval();
        Assert.assertEquals(11D, out.asDouble(), 0);
    }
    ...
    public void testAverageUngrouped() throws ParseException {
        ...
        out = gen.eval();
        Assert.assertEquals(6D, out.asDouble(), 0);
    }
    ...
    public void testAverageGrouped() throws ParseException {
        ...
        Var out = gen.eval();
        Assert.assertEquals(3.5D, out.asDouble(), 0);
    ...
    public void testMatch1() throws ParseException {
        ...
        final Var out = gen.eval();
        Assert.assertTrue(out.asBoolean());
    }
    ...
    public void testMatch2() throws ParseException {
        ...
        final Var out = gen.eval();
        Assert.assertFalse(out.asBoolean());
    }
    ...
    public void testIndexOf() throws ParseException {
        ...
        final Var out = gen.eval();
        Assert.assertEquals(2, out.asInteger().intValue());
    }
    ...
    public void testCountUniqueStaticValue() throws ParseException {
        ...
        Var out = gen.eval();
        Assert.assertEquals(1D, out.asDouble(), 0);
    ...
    public void testAdd2() throws ParseException {
        ...
        final Var out = gen.eval();
        Assert.assertEquals(12D, out.asDouble(), 0);
    }
    ...
    public void testSubtract2() throws ParseException {
        ...
        Var out = gen.eval();
        Assert.assertEquals(0D, out.asDouble(), 0);
    ...
    public void testFloorNum5() throws ParseException {
        ...
        final Var out = gen.eval();
        Assert.assertEquals(3.8D, out.asDouble(), 0);
    }
    ...
    public void testFloorNum6() throws ParseException {
        ...
        final Var out = gen.eval();
        Assert.assertEquals(3.86D, out.asDouble(), 0);
    }
    ...
    public void testCeilNum1() throws ParseException {
        ...
        final Var out = gen.eval();
        Assert.assertEquals(9D, out.asDouble(), 0);
    }
    ...
    public void testCeilNum5() throws ParseException {
        ...
        final Var out = gen.eval();
        Assert.assertEquals(3.9D, out.asDouble(), 0);
    }
    ...
    public void testCeilNum6() throws ParseException {
        ...
        final Var out = gen.eval();
        Assert.assertEquals(3.87D, out.asDouble(), 0);
    }
    ...
    private void testTime(final String function, final String in, final String expected) throws ParseException {
        ...
        gen.set(getVal(in));
        final Var out = gen.eval();
        Assert.assertEquals(expectedMs, out.asDouble(), 0);
    }
    ...
    public void testParseDate1() throws ParseException {
        ...
        Var out = gen.eval();
        Assert.assertEquals(1393071132888L, out.asLong().longValue());
    }
    ...
    public void testParseDate2() throws ParseException {
        ...
        Var out = gen.eval();
        Assert.assertEquals(1393027200000L, out.asLong().longValue());
    }
    ...
    public void testParseDate3() throws ParseException {
        ...
        gen.set(getVal("2014 02 22"));
        Var out = gen.eval();
        Assert.assertEquals(1393012800000L, out.asLong().longValue());
    }
    ...
    public void testVariance1() throws ParseException {
        ...
        Var out = gen.eval();
        Assert.assertEquals(21704D, out.asDouble(), 0);
    }
    ...
    public void testStDev1() throws ParseException {
        ...
        Var out = gen.eval();
        Assert.assertEquals(147, out.asDouble(), 0);
    }
