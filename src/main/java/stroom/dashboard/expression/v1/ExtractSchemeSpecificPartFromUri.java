...
public class ExtractSchemeSpecificPartFromUri extends ExtractionFunction {
    ...
    public static final String NAME = "extractSchemeSpecificPartFromUri";
    private static final Extractor EXTRACTOR = new ExtractorImpl();

    public ExtractSchemeSpecificPartFromUri(final String name) {
        super(name);
    }
